...
public class VendorPlate   {
  ...
  **/
  @ApiModelProperty(example = "31dd5787", value = "(Optional) The value of the bar code attached to this plate")
  ...
  **/
  @ApiModelProperty(example = "0ad6c0ef", value = "The ID which uniquely identifies this plate to the client making the request")
