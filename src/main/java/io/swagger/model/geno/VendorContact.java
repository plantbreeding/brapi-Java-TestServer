...
public class VendorContact   {
  ...
  **/
  @ApiModelProperty(example = "123 Main Street", value = "The street address of the vendor")
   ...
   * @return vendorCity
  **/
  @ApiModelProperty(example = "Townsville", value = "The name of the city where the vendor is located")
  ...
  **/
  @ApiModelProperty(example = "Bob Robertson", value = "The name or identifier of the primary vendor contact")
  ...
  **/
  @ApiModelProperty(example = "USA", value = "The name of the country where the vendor is located")
  ...
  **/
  @ApiModelProperty(example = "This is a sequencing vendor. Sequencing happens here.", value = "A description of the vendor")
   ...
   * @return vendorEmail
  **/
  @ApiModelProperty(example = "bob@bob.org", value = "The primary email address used to contact the vendor")
  ...
  **/
   ...
   * @return vendorPhone
  **/
  @ApiModelProperty(example = "+1-800-555-5555", value = "The primary phone number used to contact the vendor")
   ...
   * @return vendorURL
  **/
  @ApiModelProperty(example = "https://sequencing.org/vendor", value = "The primary URL for the vendor")
