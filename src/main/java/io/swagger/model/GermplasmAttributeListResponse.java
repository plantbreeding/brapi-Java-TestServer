...
public class GermplasmAttributeListResponse   {
  @JsonProperty("metadata")
  private Metadata metadata = null;

  @JsonProperty("result")
  private GermplasmAttributeList result = null;
  ...
  **/
  ...
  public GermplasmAttributeListResponse result(GermplasmAttributeList result) {
    this.result = result;
    return this;
  }
  ...
  **/
  ...
  public GermplasmAttributeList getResult() {
    return result;
  }

  public void setResult(GermplasmAttributeList result) {
    this.result = result;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.metadata, germplasmAttributeListResponse.metadata) &&
