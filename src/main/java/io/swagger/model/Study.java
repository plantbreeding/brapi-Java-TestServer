...
public class Study   {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(active, additionalInfo, contacts, dataLinks, endDate, lastUpdate, license, location, seasons, startDate, studyDbId, studyDescription, studyName, studyType, trialDbId, trialName);
  }
