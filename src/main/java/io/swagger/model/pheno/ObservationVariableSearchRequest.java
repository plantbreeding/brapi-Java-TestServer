...
public class ObservationVariableSearchRequest extends SearchRequestParametersPaging  {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(externalReferenceIDs, externalReferenceSources, dataTypes, methodDbIds, observationVariableDbIds, observationVariableNames, ontologyDbIds, scaleDbIds, studyDbId, traitClasses, traitDbIds, super.hashCode());
  }
