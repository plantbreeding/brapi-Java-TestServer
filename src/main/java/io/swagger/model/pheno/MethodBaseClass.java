...
public class MethodBaseClass   {
  ...
  public MethodBaseClass additionalInfo(Map<String, String> additionalInfo) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(additionalInfo, bibliographicalReference, description, externalReferences, formula, methodClass, methodName, ontologyReference);
  }
