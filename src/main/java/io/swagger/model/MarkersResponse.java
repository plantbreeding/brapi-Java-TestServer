...
public class MarkersResponse   {
  ...
  **/
  ...
  public MarkersResponse result(MarkersResponseResult result) {
    this.result = result;
    return this;
  }
  ...
  **/
  ...
  public void setResult(MarkersResponseResult result) {
    this.result = result;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    MarkersResponse markersResponse = (MarkersResponse) o;
    return Objects.equals(this.metadata, markersResponse.metadata) &&
        Objects.equals(this.result, markersResponse.result);
  }
  ...
  public String toString() {
    ...
    sb.append("class MarkersResponse {\n");
