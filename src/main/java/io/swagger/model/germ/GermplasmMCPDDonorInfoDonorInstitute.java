...
public class GermplasmMCPDDonorInfoDonorInstitute   {
  ...
  **/
  @ApiModelProperty(example = "PER001", value = "MCPD (v2.1) (DONORCODE) 22. FAO WIEWS code of the donor institute. Follows INSTCODE standard.")
  ...
  **/
  @ApiModelProperty(example = "The BrAPI Institute", value = "MCPD (v2.1) (DONORNAME) 22.1  Name of the donor institute (or person). This descriptor should be used only if DONORCODE can not be filled because the FAO WIEWS code for this institute is not available.")
