...
public class GermplasmNewRequest   {
  ...
  **/
  @ApiModelProperty(example = "Maize", required = true, value = "Common name for the crop   MCPD (v2.1) (CROPNAME) 10. Common name of the crop. Example: \"malting barley\", \"mas\".")
      @NotNull
  ...
  **/
   ...
   * @return germplasmPUI
  **/
  @ApiModelProperty(example = "http://pui.per/accession/A0000003", required = true, value = "The Permanent Unique Identifier which represents a germplasm  MIAPPE V1.1 (DM-41) Biological material ID - Code used to identify the biological material in the data file. Should be unique within the Investigation. Can correspond to experimental plant ID, seed lot ID, etc This material identification is different from a BiosampleID which corresponds to Observation Unit or Samples sections below.")
      @NotNull
