...
public enum GermplasmStorageTypesEnum   {
  /**
   ...
   */
    ...
    @JsonCreator
    public static GermplasmStorageTypesEnum fromValue(String text) {
      for (GermplasmStorageTypesEnum b : GermplasmStorageTypesEnum.values()) {
