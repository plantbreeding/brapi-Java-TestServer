...
public class StudyTypesResponseResult   {
  @JsonProperty("data")
  @Valid
  private List<StudyType> data = null;

  public StudyTypesResponseResult data(List<StudyType> data) {
    this.data = data;
    return this;
  }

  public StudyTypesResponseResult addDataItem(StudyType dataItem) {
    if (this.data == null) {
      this.data = new ArrayList<StudyType>();
    }
