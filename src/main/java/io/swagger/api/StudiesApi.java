...
public interface StudiesApi {
    ...
    @RequestMapping(value = "/studies/{studyDbId}/observations",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<ObservationsResponse> studiesStudyDbIdObservationsGet(@ApiParam(value = "Identifier of the study. Usually a number, could be alphanumeric.",required=true) @PathVariable("studyDbId") String studyDbId,@ApiParam(value = "Numeric `id` of that variable (combination of trait, unit and method)") @Valid @RequestParam(value = "observationVariableDbIds", required = false) List<String> observationVariableDbIds,@ApiParam(value = "Which result page is requested. The page indexing starts at 0 (the first page is 'page'= 0). Default is `0`.") @Valid @RequestParam(value = "page", required = false) Integer page,@ApiParam(value = "The size of the pages to be returned. Default is `1000`.") @Valid @RequestParam(value = "pageSize", required = false) Integer pageSize,@ApiParam(value = "HTTP HEADER - Token used for Authorization   <strong>Bearer {token_string} </strong>" ) @RequestHeader(value="Authorization", required=false) String authorization) throws BrAPIServerException;
    ...
    @RequestMapping(value = "/studies/{studyDbId}/observationunits",
        ...
        consumes = { "application/json" },
        method = RequestMethod.PUT)
    ResponseEntity<NewObservationUnitDbIdsResponse> studiesStudyDbIdObservationunitsPut(@ApiParam(value = "The study these observation units are related to.",required=true) @PathVariable("studyDbId") String studyDbId,@ApiParam(value = ""  )  @Valid @RequestBody List<NewObservationUnitRequest> body,@ApiParam(value = "HTTP HEADER - Token used for Authorization   <strong>Bearer {token_string} </strong>" ) @RequestHeader(value="Authorization", required=false) String authorization) throws BrAPIServerException;
    ...
    @ApiOperation(value = "Get the Observations for a specific Study in a table format", nickname = "studiesStudyDbIdTableGet", notes = "Retrieve the details of the study required for field data collection. Includes actual trait data.", response = StudyobservationsTableResponse.class, authorizations = {
        @Authorization(value = "AuthorizationToken")
    }, tags={ "Studies","Observations", })
    @ApiResponses(value = { 
