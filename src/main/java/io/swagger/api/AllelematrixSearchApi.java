...
public interface AllelematrixSearchApi {
    ...
    ResponseEntity<AlleleMatrixValuesResponse> allelematrixSearchPost(@ApiParam(value = "The markerprofile db ids. Not Required if 'markerDbId' or 'matrixDbId' is present." ,required=true )  @Valid @RequestBody AlleleMatrixSearchRequest markerprofileDbId);
