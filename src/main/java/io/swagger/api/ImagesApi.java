...
public interface ImagesApi {
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "OK", response = ImagesResponse.class),
			@ApiResponse(code = 400, message = "Bad Request", response = String.class),
			@ApiResponse(code = 401, message = "Unauthorized", response = String.class),
			@ApiResponse(code = 403, message = "Forbidden", response = String.class) })
	@RequestMapping(value = "/images", produces = { "application/json" }, method = RequestMethod.GET)
	ResponseEntity<ImagesResponse> imagesGet(
			...
			@ApiParam(value = "The unique identifier of the observation an image is accosiated with") @Valid @RequestParam(value = "observationDbId", required = false) String observationDbId,
	...
	ResponseEntity<ImageResponse> imagesImageDbIdGet(
	...
	ResponseEntity<ImageResponse> imagesImageDbIdImagecontentPut(
			@ApiParam(value = "The unique identifier for a image", required = true) @PathVariable("imageDbId") String imageDbId,
	...
	ResponseEntity<ImageResponse> imagesImageDbIdPut(
			@ApiParam(value = "The unique identifier for a image", required = true) @PathVariable("imageDbId") String imageDbId,
			@ApiParam(value = "") @Valid @RequestBody NewImageRequest body,
			@ApiParam(value = "HTTP HEADER - Token used for Authorization   <strong>Bearer {token_string} </strong>") @RequestHeader(value = "Authorization", required = false) String authorization)
			throws BrAPIServerException;
	...
	ResponseEntity<ImageResponse> imagesPost(@ApiParam(value = "") @Valid @RequestBody NewImageRequest body,
			@ApiParam(value = "HTTP HEADER - Token used for Authorization   <strong>Bearer {token_string} </strong>") @RequestHeader(value = "Authorization", required = false) String authorization)
			throws BrAPIServerException;
