...
public interface AllelematricesSearchApi {
    ...
    ResponseEntity<AlleleMatrixValuesResponse> allelematricesSearchPost(@ApiParam(value = "The markerprofile db ids. Not Required if 'markerDbId' or 'matrixDbId' is present." ,required=true )  @Valid @RequestBody AlleleMatrixSearchRequest markerprofileDbId) throws BrAPIServerException;
