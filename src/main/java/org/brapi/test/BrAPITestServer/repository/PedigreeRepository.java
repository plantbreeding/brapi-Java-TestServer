...
public interface PedigreeRepository extends PagingAndSortingRepository<PedigreeEntity, String> {
	...
	public Page<PedigreeEntity> findByParent1_IdOrParent2_Id(String germplasmDbId, String germplasmDbId2);
	...
	public Page<PedigreeEntity> findSiblings(@Param("parent1") String parent1, @Param("parent2") String parent2);
}
