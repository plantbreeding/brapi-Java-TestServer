...
public class ProgramRepositoryImpl implements ProgramRepositoryCustom {
	...
	@Override
	public Page<ProgramEntity> findAllBySearch(ProgramSearchRequest request, Pageable pageReq) {
	...
	public String buildQueryString(ProgramSearchRequest request, Map<String, Object> params) {
