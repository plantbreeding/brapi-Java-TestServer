...
public class CallsService {
	...
	static {
		...
		calls.add("{\"call\": \"phenotypes-search/csv\", \"methods\": [\"POST\"], \"datatypes\": [\"application/json\"], \"dataTypes\": [\"application/json\"], \"versions\": [\"1.2\"]}");
		calls.add("{\"call\": \"phenotypes-search/table\", \"methods\": [\"POST\"], \"datatypes\": [\"application/json\"], \"dataTypes\": [\"application/json\"], \"versions\": [\"1.2\"]}");
		calls.add("{\"call\": \"phenotypes-search/tsv\", \"methods\": [\"POST\"], \"datatypes\": [\"application/json\"], \"dataTypes\": [\"application/json\"], \"versions\": [\"1.2\"]}");
		...
		calls.add("{\"call\": \"search/observationtables/{searchResultsDbId}\", \"methods\": [\"GET\"], \"datatypes\": [\"application/json\"], \"dataTypes\": [\"application/json\"], \"versions\": [\"1.3\"]}");
		...
		calls.add("{\"call\": \"studies/{studyDbId}/table\", \"methods\": [\"GET\", \"POST\"], \"datatypes\": [\"application/json\"], \"dataTypes\": [\"application/json\"], \"versions\": [\"1.0\", \"1.1\", \"1.2\", \"1.3\"]}");
