...
public class VendorApiController implements VendorApi {
    ...
    public ResponseEntity<VendorOrderListResponse> vendorOrdersGet(@ApiParam(value = "The order id returned by the vendor when the order was successfully submitted. From response of \"POST /vendor/orders\"") @Valid @RequestParam(value = "orderId", required = false) String orderId
...
,@ApiParam(value = "HTTP HEADER - Token used for Authorization   <strong> Bearer {token_string} </strong>" ) @RequestHeader(value="Authorization", required=false) String authorization
    ...
    public ResponseEntity<VendorPlateListResponse> vendorOrdersOrderIdPlatesGet(@ApiParam(value = "The order id returned by the vendor when the order was successfully submitted.",required=true) @PathVariable("orderId") String orderId
,@ApiParam(value = "Used to request a specific page of data to be returned.  The page indexing starts at 0 (the first page is 'page'= 0). Default is `0`.") @Valid @RequestParam(value = "page", required = false) Integer page
,@ApiParam(value = "The size of the pages to be returned. Default is `1000`.") @Valid @RequestParam(value = "pageSize", required = false) Integer pageSize
,@ApiParam(value = "HTTP HEADER - Token used for Authorization   <strong> Bearer {token_string} </strong>" ) @RequestHeader(value="Authorization", required=false) String authorization
) {
    ...
    public ResponseEntity<VendorResultFileListResponse> vendorOrdersOrderIdResultsGet(@ApiParam(value = "The order id returned by the vendor when the order was successfully submitted.",required=true) @PathVariable("orderId") String orderId
,@ApiParam(value = "Used to request a specific page of data to be returned.  The page indexing starts at 0 (the first page is 'page'= 0). Default is `0`.") @Valid @RequestParam(value = "page", required = false) Integer page
,@ApiParam(value = "The size of the pages to be returned. Default is `1000`.") @Valid @RequestParam(value = "pageSize", required = false) Integer pageSize
,@ApiParam(value = "HTTP HEADER - Token used for Authorization   <strong> Bearer {token_string} </strong>" ) @RequestHeader(value="Authorization", required=false) String authorization
) {
    ...
    public ResponseEntity<VendorOrderStatusResponse> vendorOrdersOrderIdStatusGet(@ApiParam(value = "The order id returned by the vendor when the order was successfully submitted.",required=true) @PathVariable("orderId") String orderId
,@ApiParam(value = "HTTP HEADER - Token used for Authorization   <strong> Bearer {token_string} </strong>" ) @RequestHeader(value="Authorization", required=false) String authorization
) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
    ...
    public ResponseEntity<VendorOrderSubmissionSingleResponse> vendorOrdersPost(@ApiParam(value = ""  )  @Valid @RequestBody VendorOrderSubmissionRequest body
,@ApiParam(value = "HTTP HEADER - Token used for Authorization   <strong> Bearer {token_string} </strong>" ) @RequestHeader(value="Authorization", required=false) String authorization
) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
    ...
    public ResponseEntity<VendorPlateSubmissionIdSingleResponse> vendorPlatesPost(@ApiParam(value = ""  )  @Valid @RequestBody VendorPlateSubmissionRequest body
,@ApiParam(value = "HTTP HEADER - Token used for Authorization   <strong> Bearer {token_string} </strong>" ) @RequestHeader(value="Authorization", required=false) String authorization
) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
    ...
    public ResponseEntity<VendorPlateSubmissionSingleResponse> vendorPlatesSubmissionIdGet(@ApiParam(value = "The submission id returned by the vendor when a set of plates was successfully submitted. From response of \"POST /vendor/plates\"",required=true) @PathVariable("submissionId") String submissionId
,@ApiParam(value = "HTTP HEADER - Token used for Authorization   <strong> Bearer {token_string} </strong>" ) @RequestHeader(value="Authorization", required=false) String authorization
) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
    ...
    public ResponseEntity<VendorSpecificationSingleResponse> vendorSpecificationsGet(@ApiParam(value = "HTTP HEADER - Token used for Authorization   <strong> Bearer {token_string} </strong>" ) @RequestHeader(value="Authorization", required=false) String authorization
) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
