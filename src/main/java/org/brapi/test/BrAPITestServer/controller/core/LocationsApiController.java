...
public class LocationsApiController implements LocationsApi {
    ...
    public ResponseEntity<LocationListResponse> locationsGet(@ApiParam(value = "Filter by location type specified.") @Valid @RequestParam(value = "locationType", required = false) String locationType
...
,@ApiParam(value = "HTTP HEADER - Token used for Authorization   <strong> Bearer {token_string} </strong>" ) @RequestHeader(value="Authorization", required=false) String authorization
    ...
    public ResponseEntity<LocationSingleResponse> locationsLocationDbIdGet(@ApiParam(value = "The internal DB id for a location",required=true) @PathVariable("locationDbId") String locationDbId
,@ApiParam(value = "HTTP HEADER - Token used for Authorization   <strong> Bearer {token_string} </strong>" ) @RequestHeader(value="Authorization", required=false) String authorization
) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
    ...
    public ResponseEntity<LocationSingleResponse> locationsLocationDbIdPut(@ApiParam(value = "The internal DB id for a location",required=true) @PathVariable("locationDbId") String locationDbId
...
,@ApiParam(value = "HTTP HEADER - Token used for Authorization   <strong> Bearer {token_string} </strong>" ) @RequestHeader(value="Authorization", required=false) String authorization
    ...
    public ResponseEntity<LocationListResponse> locationsPost(@ApiParam(value = ""  )  @Valid @RequestBody List<LocationNewRequest> body
,@ApiParam(value = "HTTP HEADER - Token used for Authorization   <strong> Bearer {token_string} </strong>" ) @RequestHeader(value="Authorization", required=false) String authorization
) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
