...
public class GermplasmAttributeController extends BrAPIController{
	...
	public SearchResults<SearchResultsList<GermplasmAttribute>> getGermplasmAttributes(
	...
	public SearchResults<SearchResultsList<GermplasmAttribute>> getGermplasmAttributeCategories(
				@RequestParam(defaultValue="0") int page,
				@RequestParam(defaultValue="1000") int pageSize){
	...
	public SearchResults<GermplasmAttributeMasterWrapper> getGermplasmAttributeByGermplasmDbId(
		...
		return SearchResults.withObject(attribute).withMetaData(mockMetaData(page, pageSize));
	}
