...
public class CommoncropnamesApiController implements CommoncropnamesApi {
    ...
    public ResponseEntity<CommonCropNamesResponse> commoncropnamesGet(@ApiParam(value = "Used to request a specific page of data to be returned.  The page indexing starts at 0 (the first page is 'page'= 0). Default is `0`.") @Valid @RequestParam(value = "page", required = false) Integer page
