...
INSERT INTO scale (id, data_type, decimal_places, units, scale_name, valid_value_min, valid_value_max, ontology_id, scalepui) VALUES ('scale_variable1', 4, 1, 'cm', 'Centimeter', '0', '99999', 'ontology_variable1', 'http://dx.doi.org/10.1234/brapi000');
INSERT INTO method(id, description, formula, method_class, name, reference, ontology_id, methodpui) VALUES ('method_variable1', 'Standard rolled measuring tape', 'a^2 + b^2 = c^2', 'Numeric', 'Tape Measure', 'google.com', 'ontology_variable1', 'http://dx.doi.org/10.1234/brapi000');
INSERT INTO trait (id, attribute, attributepui, entity, entitypui, main_abbreviation, trait_description, trait_name, status, trait_class, ontology_id, traitpui) VALUES ('trait_variable1', 'height', 'http://dx.doi.org/10.1234/brapi000', 'stalk', 'http://dx.doi.org/10.1234/brapi000', 'H', 'plant height', 'Plant Height', 'active', 'Numeric', 'ontology_variable1', 'http://dx.doi.org/10.1234/brapi000');

INSERT INTO observation_variable (id, pui, default_value, documentationurl, growth_stage, institution, "language", scientist, status, submission_timestamp, crop_id, method_id, ontology_id, scale_id, trait_id, "name") VALUES ('variable1', 'http://dx.doi.org/10.1234/brapi000', '10', 'https://brapi.org', '1', 'Cornell', 'English', 'Bob', 'active', '2011-06-14T22:12:51Z', '1', 'method_variable1', 'ontology_variable1', 'scale_variable1', 'trait_variable1', 'Plant Height');
...
INSERT INTO scale (id, data_type, decimal_places, units, scale_name, valid_value_min, valid_value_max, ontology_id, scalepui) VALUES ('scale_variable2', 4, 1, 'cm', 'Centimeter', '0', '99999', 'ontology_variable1', 'http://dx.doi.org/10.1234/brapi000');
INSERT INTO method(id, description, formula, method_class, name, reference, ontology_id, methodpui) VALUES ('method_variable2', 'Standard rolled measuring tape', 'a^2 + b^2 = c^2', 'Numeric', 'Tape Measure', 'google.com', 'ontology_variable1', 'http://dx.doi.org/10.1234/brapi000');
INSERT INTO trait (id, attribute, attributepui, entity, entitypui, main_abbreviation, trait_description, trait_name, status, trait_class, ontology_id, traitpui) VALUES ('trait_variable2', 'height', 'http://dx.doi.org/10.1234/brapi000', 'stalk', 'http://dx.doi.org/10.1234/brapi000', 'H', 'plant height', 'Plant Height', 'active', 'Numeric', 'ontology_variable1', 'http://dx.doi.org/10.1234/brapi000');

INSERT INTO observation_variable (id, pui, default_value, documentationurl, growth_stage, institution, "language", scientist, status, submission_timestamp, crop_id, method_id, ontology_id, scale_id, trait_id, "name") VALUES ('variable2', 'http://dx.doi.org/10.1234/brapi000', '20', 'https://brapi.org', '1', 'Cornell', 'English', 'Bob', 'active', '2012-06-24T22:22:52Z', '1', 'method_variable2', 'ontology_variable1', 'scale_variable2', 'trait_variable2', 'Plant Height');
