...
INSERT INTO event_param (id, "key", rdf_value, value, event_id) VALUES('event_param2', 'fertilizer', null, 'Nitro+', 'event1');

INSERT INTO additional_info(id, key, value) VALUES ('event_ai_1', 'dummyData', decode('ACED000574000454727565','hex'));
