...
-- attribute def 2
INSERT INTO scale (id, data_type, decimal_places, scale_name, valid_value_min, valid_value_max, ontology_id) VALUES ('scale_attribute2', 4, 2, 'Centimeter', '0', '99999', 'ontology_attribute1');
INSERT INTO method(id, description, formula, method_class, name, reference, ontology_id) VALUES ('method_attribute2', 'Standard rolled measuring tape', 'a^2 + b^2 = c^2', 'Numeric', 'Tape Measure', 'google.com', 'ontology_attribute1');
INSERT INTO trait (id, attribute, entity, main_abbreviation, trait_description, trait_name, status, trait_class, ontology_id) VALUES ('trait_attribute2', 'height', 'stalk', 'H', 'plant height', 'Plant Height', 'active', 'Numeric', 'ontology_attribute1');
INSERT INTO germplasm_attribute_definition (id, default_value, documentationurl, growth_stage, institution, "language", scientist, status, submission_timestamp, crop_id, method_id, ontology_id, scale_id, trait_id, attribute_category, code, "datatype", description, "name", uri) VALUES ('attribute2', '20', 'https://brapi.org', '1', 'Cornell', 'English', 'Bob', 'active', '2011-06-24T22:22:52Z', '1', 'method_attribute2', 'ontology_attribute1', 'scale_attribute2', 'trait_attribute2', 'Morphological', 'RHT', 'Categorical', 'Allele of marker 22_4769', 'Rht-B2b', 'http://www.brapi.org/ontology/MO_223:2000002');
