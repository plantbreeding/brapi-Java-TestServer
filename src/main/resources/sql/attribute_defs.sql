...
INSERT INTO scale (id, data_type, decimal_places, scale_name, valid_value_min, valid_value_max, ontology_id)	VALUES ('s1', 4, 1, 'Centimeter', '0', '99999', 'MO_123');
...
INSERT INTO trait (id, attribute, entity, main_abbreviation, trait_description, trait_name, status, trait_class, ontology_id) VALUES ('t1', 'height', 'stalk', 'H', 'plant height', 'Plant Height', 'active', 'Numeric', 'MO_123');
