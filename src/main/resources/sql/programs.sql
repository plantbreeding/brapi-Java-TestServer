...
INSERT INTO program (crop_id, id, abbreviation, lead_person_id, documentationurl, objective, name, program_type, funding_information) VALUES ('1', 'program1', 'P1', 'program_person_1', 'https://brapi.org', 'Global Population Improvement', 'The BrAPI Breeding Program', 0, 'Generic funding information');
INSERT INTO additional_info(id, key, value) VALUES ('program_ai_1', 'dummyData', decode('ACED000574000454727565','hex'));
...
INSERT INTO program (crop_id, id, abbreviation, lead_person_id, documentationurl, objective, name, program_type, funding_information) VALUES ('1', 'program2', 'P2', 'program_person_2', 'https://brapi.org', 'XYZ', 'The Fake Tomatillo Breeding Program', 0, 'USDA Grant 0123456789');
INSERT INTO additional_info(id, key, value) VALUES ('program_ai_2', 'dummyData', decode('ACED000574000454727565','hex'));
...
INSERT INTO program (crop_id, id, abbreviation, lead_person_id, documentationurl, objective, name, program_type, funding_information) VALUES ('2', 'program3', 'P3', 'program_person_3', 'https://brapi.org', 'XYZ', 'The Fake Pawpaw Breeding Program', 1, 'Elixir Project 0123456789');
INSERT INTO additional_info(id, key, value) VALUES ('program_ai_3', 'dummyData', decode('ACED000574000454727565','hex'));
