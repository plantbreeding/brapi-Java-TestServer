...
INSERT INTO program (crop_id, id, abbreviation, lead_person_id, documentationurl, objective, name) VALUES ('1', 'program1', 'P1', 'program_person_1', 'https://brapi.org', 'Global Population Improvement', 'Program 1');
...
INSERT INTO program (crop_id, id, abbreviation, lead_person_id, documentationurl, objective, name) VALUES ('1', 'program2', 'P2', 'program_person_2', 'https://brapi.org', 'XYZ', 'Program 2');
...
INSERT INTO program (crop_id, id, abbreviation, lead_person_id, documentationurl, objective, name) VALUES ('2', 'program3', 'P3', 'program_person_3', 'https://brapi.org', 'XYZ', 'Program 3');
