...
INSERT INTO person(id, description, email_address, institute_name, first_name, last_name, mailing_address, middle_name, phone_number, userid) VALUES ('study_contact_1', 'Breeder', 'd.breeder@brapi.org', 'Plant Science Institute', 'Dave', 'Breeder', '123 Road Street, City, State, Country, 98765', '', '+19876543210', '0000-0002-0617-9556');
...
INSERT INTO additional_info(id, key, value) VALUES ('study_ai_1', 'dummyData', decode('ACED000574000454727565','hex'));
...
--study 2
INSERT INTO study(id, active, cultural_practices, documentationurl, end_date, license, observation_units_description, start_date, study_code, study_description, study_name, studypui, study_type, location_id, trial_id, program_id, crop_id) VALUES ('study2', true, 'Irrigation was applied according needs during summer to prevent water stress', 'https://brapi.org', '2014-02-02', 'https://creativecommons.org/licenses/by/4.0', 'Observation units consisted in individual plots themselves consisting of a row of 15 plants at a density of approximately six plants per square meter.', '2013-02-02', 'Yield_2013', 'This is a yield trial for 2013', 'Paw paw 2013 yield trial', 'doi:10.255454/fake/22345', 'Phenotyping','location_02', 'trial2', 'program2', '1');

INSERT INTO person(id, description, email_address, institute_name, first_name, last_name, mailing_address, middle_name, phone_number, userid) VALUES ('study_contact_2', 'Breeder', 'e.breeder@brapi.org', 'Plant Science Institute', 'Eve', 'Breeder', '123 Road Street, City, State, Country, 98765', '', '+19876543210', '0000-0002-0632-8751');
...
INSERT INTO additional_info(id, key, value) VALUES ('study_ai_2', 'dummyData', decode('ACED000574000454727565','hex'));
