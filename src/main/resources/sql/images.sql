...
INSERT INTO additional_info(id, key, value) VALUES ('image_ai_1', 'dummyData', decode('ACED000574000454727565','hex'));
...
INSERT INTO image (id, copyright, description, image_file_name, image_file_size, image_height, imagemimetype, imageurl, image_width, "name", time_stamp, coordinates_id, observation_unit_id) VALUES('image2', 'Copyright 2018 Bob Robertson', 'This is an example image', 'tomato.jpg', 50000, 500, 'image/jpg', 'https://wiki.brapi.org/images/tomato.jpg', 500, 'Example Image', '2019-12-02', 'image_geo_2', null);
...
INSERT INTO additional_info(id, key, value) VALUES ('image_ai_2', 'dummyData', decode('ACED000574000454727565','hex'));
